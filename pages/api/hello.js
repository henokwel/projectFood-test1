...
export default function handler(req, res) {
  ...
  // // fetch(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=59.342543095794134%2C18.039535550938297&radius=1500&type=restaurant&keyword=restaurant&key=${process.env.MY_KEY}`)
  //   .then(res => res.json())
  //   .then(data => {
